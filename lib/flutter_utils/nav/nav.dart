...
import '../../authentication_firebase/base_auth_user_provider.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const CalculateWidget() : const CreateWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'calculate',
          path: '/calculate',
          builder: (context, params) => const CalculateWidget(),
        )
